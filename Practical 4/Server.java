...
System.out.println("Tushar Patil (4247)");
...
System.out.println("Server: new client accepted. client ip and port: " + clientIP + ":" +clientPort);
...
System.out.println("Server: recv from client(" + clientIPs.get(i) + ":" + clientPorts.get(i) + "): '" + recvBuf[i] + "'");
...
System.out.println("Server: received client local clock (string) is " + substrAfterLastSpace);
float substrAfterLastSpaceF = Float.parseFloat(substrAfterLastSpace);
System.out.println("Server: received client local clock (float) is " + substrAfterLastSpaceF);
